...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [ 
	    InlineKeyboardButton(text="⚡ ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ⚡", url='https://telegram.me/Moviee_pitara'),
        ] 
    )
    if 0 < offset <= 10:
        off_set = 0
...
async def cb_handler(client: Client, query: CallbackQuery):
        ...
        if chat_type == enums.ChatType.PRIVATE:
            ...
            if grpid is not None:
                ...
                try:
                    ...
                    return await query.answer('♥️ Love @team_vipers ♥️')
            else:
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('⪦ 𝕄𝕆𝕍𝕀𝔼 ℂℍ𝔸ℕℕ𝔼𝕃 ⪧', url='https://t.me/Moviee_pitara')
        ],[
            InlineKeyboardButton('💸 E𝐚𝐫𝐧 M𝐨𝐧𝐞𝐲 💸', callback_data="shortlink_info")
        ],[
                InlineKeyboardButton(
                    "🦋 SUBSCRIBE YT Channel 🦋", url='https://youtube.com/@DecodingThings'
                )
            ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        await query.answer('♥️ Thank You Mrviper ♥️')
        ...
        buttons = InlineKeyboardMarkup(
            ...
            InlineKeyboardButton('💤Developer', url='https://telegram.me/Team_vipers')
            ],[
            InlineKeyboardButton('🔐 Close', callback_data='close_data')
            ]]
        ...
        try:
            btn = [[
                ...
                InlineKeyboardButton(text=f"🐞 ══• ʀᴇᴘᴏʀᴛ ɪꜱꜱᴜᴇ •══ 🐞", url=f"https://telegram.me/Moviee_pitara")
            ]]
            btn_lzdv = [
                [
    ...
    if imdb and imdb.get('poster'):
        try:
            z = await message.reply_photo(photo=imdb.get('poster'), caption=cap[:1024],
                                        reply_markup=InlineKeyboardMarkup(btn))
            thanksaa = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/Team_vipers'>𓆩• MrViper •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
            ...
            thanks = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/Team_vipers'>𓆩• MrViper •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
            await asyncio.sleep(5)
            await thanks.delete()
            if SELF_DELETE:
                await asyncio.sleep(SELF_DELETE_SECONDS)
            ...
            thanksz = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/Team_vipers'>𓆩• Mrviper •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
            await asyncio.sleep(5)
        ...
        thanksx = await message.reply_text(f"♥ Heads up for **<a href='https://t.me/Team_vipers'>𓆩• MrViper •𓆪</a>**...\n<code>🎉 we love you 🎊</code>")
        await asyncio.sleep(5)
